...
{{--                                    <img src="{{ asset('assets/img/about-img.jpg') }}" class="img-circle delay-03s animated wow zoomIn" alt="">--}}
                                </div>
            ...
            @if(isset($tags))
                <div id="filters" class="sixteen columns">
                    <ul class="clearfix">
                        ...
                        @foreach($tags as $teg)
                            <li><a class="" href="#" data-filter=".{{ $teg }}">
                                    <h5>{{ $teg }}</h5>
                                </a></li>
                        @endforeach
...
{{--                            </a></li>--}}
            ...
            <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">
                ...
                @foreach($portfolios as $portf)
                    <!-- Portfolio Item -->
                        <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four {{ $portf->filter }} isotope-item">
                            <div class="portfolio_img"> <img src="{{ asset('assets/img/'.$portf->images) }}"  alt="Portfolio 1"> </div>
                            <div class="item_overlay">
                                <div class="item_info">
                                    <h4 class="project_name">{{ $portf->name }}</h4>
                                </div>
                            </div>
                        </div>
                        <!--/Portfolio Item -->
...
{{--                <!-- Portfolio Item-->--}}
{{--                <div class="portfolio-item one-four  design isotope-item">--}}
...
<footer class="footer_wrapper" id="contact">
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © 2019,    Template by <a href="http://webthemez.com">WebThemez.com</a>. </span> </div>
    </div>
</footer>
