...
{{--    </div>--}}
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="name" class="form-control" id="name" placeholder="Введите название страницы" value="{{ old('name') }}">
        </div>
    </div>
...
{{--    </div>--}}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <input type="text" name="alias" class="form-control" id="alias" placeholder="Введите алис" value="{{ old('alias') }}">
                </div>
            </div>
...
{{--    </div>--}}
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <textarea name="text" class="form-control" id="editor" placeholder="Введите текст страницы">{{ old('text') }}</textarea>
                </div>
            </div>
